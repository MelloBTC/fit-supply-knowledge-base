...
| Pricing and Quote Creation | Can the offer be priced accurately, profitably, and with correct freight/install assumptions? | `sales`, `governance` | Strong case signal; full quote/pricing page deferred. | Avoid confident product/pricing claims without source/freshness controls. |
